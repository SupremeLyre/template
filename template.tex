\documentclass[12pt,a4paper,AutoFakeBold]{ctexart}
%Include graphics
\usepackage{graphicx}
\usepackage{graphics}
\usepackage{color}
...
\lstdefinelanguage{zsh}{
    morekeywords={cd,sudo,ln,ls},
    morecomment=[l]{\#},
    morestring=[b]"
}
\lstdefinelanguage{GAMMA}{
    morekeywords={mkdir,cp,ls,par_ASAR,create_offset,init_offset_orbit,offset_pwr,offset_fit,SLC_interp,SLC_intf,base_init,create_dem_par,gc_map,geocode,create_diff_par,offset_pwrm,offset_fitm,gc_map_fine,geocode,sub_phase,dismph_pwr,rasmph_pwr,base_add,multi_look,cc_wave,discc,rascc,base_perp,disrmg,rasdt_pwr24,phase_sim,adf,rascc_mask,mcf,dispmap,geocode_back,data2geotiff,kml_map,disrmg,rasrmg,dis2pwr,dishgt,rashgt,dispwr,raspwr,mk_tab,mk_mli_all,base_calc,mk_diff_2d,mk_adf_2d,mk_unw_2d,mk_base_2d,temp_lin_var,single_class_mapping,image2pt,mk_d2pt,ras_data_pt,MLI2pt,prox_prt,spf_pt,mb_pt,pdisdt_pwr24,prasdt_pwr24,thres_msk_pt,tpf_pt,sub_phase_pt,dispmap_pt,base_orbit_pt,def_mod_pt,cct_pt,vu_disp,pt2geo,pt2d,ras8_float,comb_hsi,disp_prt,kml_pt},
    sensitive=true,
    morecomment=[l]{\#},
    morestring=[b]"
}
